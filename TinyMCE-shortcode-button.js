...
( function() {
    tinymce.PluginManager.add( 'TMCEBB_shortcode_button', function( editor, url ) {
        ...
        editor.addButton( 'TMCEBB_URL_shortcode_key', {
        ...
        editor.addButton( 'TMCEBB_col_6_shortcode_key', {
        ...
        //col-8/col-4
        // Add a button that opens a window
        editor.addButton( 'TMCEBB_col_84_shortcode_key', {
        ...
        //col-4/col-8
        // Add a button that opens a window
        editor.addButton( 'TMCEBB_col_48_shortcode_key', {
        ...
        //col-4/col-4/col-4
        // Add a button that opens a window
        editor.addButton( 'TMCEBB_col_444_shortcode_key', {
